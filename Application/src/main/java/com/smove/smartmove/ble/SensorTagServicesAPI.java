package com.smove.smartmove.ble;
...
public class SensorTagServicesAPI {
    ...
    static UUID accelServiceUuid = UUID.fromString("f000aa10-0451-4000-b000-000000000000");
    static UUID accelDataUuid = UUID.fromString("f000aa11-0451-4000-b000-000000000000");
    static UUID accelConfigUuid = UUID.fromString("f000aa12-0451-4000-b000-000000000000");
    static UUID accelPeriodUuid = UUID.fromString("f000aa13-0451-4000-b000-000000000000");

    static UUID gyroServiceUuid = UUID.fromString("f000aa50-0451-4000-b000-000000000000");
    static UUID gyroDataUuid = UUID.fromString("f000aa51-0451-4000-b000-000000000000");
    static UUID gyroConfigUuid = UUID.fromString("f000aa52-0451-4000-b000-000000000000");
    static UUID gyroPeriodUuid = UUID.fromString("f000aa53-0451-4000-b000-000000000000");
    ...
    public static void setAccelerometerPeriod(BluetoothGatt bluetoothGatt, int period){
    ...
    public static void setGyroscopePeriod(BluetoothGatt bluetoothGatt, int period){
